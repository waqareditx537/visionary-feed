...
export function VideoModal({
  ...
  const handleDownload = async () => {
    await downloadFile(item.downloadUrl, `downterest-${item.id}.mp4`);
  };
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-3xl bg-card rounded-2xl overflow-hidden shadow-2xl animate-scale-in"
